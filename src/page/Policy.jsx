        ...
        <>
            ...
            <div className='policy pb-5'>
                <div className='container-cos'>
                    ...
                    <p>If you purchase Clubmall's products and services, we collect billing and credit card information. This information is used to complete the purchase transaction.</p>
                    <p className='mt-3'>Clubmall may also collect anonymous demographic information, which is not unique to you, such as your:</p>
                    ...
                    <p className='mt-2'>Clubmall collects and uses your personal information to operate and deliver the services you have requested.</p>
                    <p className='mt-3'>Clubmall may also use your personally identifiable information to inform you of other products or services available from Clubmall.</p>
                    ...
                    <ul className='mt-3'>
                        ...
                        <li><span>Enable solely internal uses that are reasonably aligned with your expectations based on your relationship with us;
                        </span></li>
